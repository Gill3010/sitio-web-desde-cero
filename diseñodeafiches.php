...
<head>
    ...
    <title>Diseño de Afiches o Carteles Galería-Virtual</title>
...
<body>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
        ...
        <main>
            <img src="img/diseño.jpg" class="banner"> 
            <div class=" bg-gris-2">
                <div class="container px-lg-5 bg-white">
                    <div class="pt-4 pb-5">
                        <div class="d-flex flex-column mb-3">
                            <h2> Diseño de Afiches o Carteles Científicos Modernos (Formatos, Colores, Ilustraciones, Tamaño)
                            </h2>
                        </div>
                        <div>
                            <p class="text-justify">
                                Un cartel científico es una representación visual que integran información derivada de datos y gráficos para transmitir conocimiento.
                                Un cartel se compone básicamente de un fondo, imagen y tipografía. 
                                <strong class="font-weight-bold"> La característica principal del cartel es que debe ser fácil de visualizar, con pocas palabras pero que se entienda, que llame la atención, que tenga simplicidad y que exprese el mensaje con la menor cantidad de elementos.</strong>
                            </p>
                            <p class="text-justify">
                                <strong class="font-weight-bold">¿Cómo elaborar un cartel correctamente? </strong> <br> Te ayudamos a lograr presentaciones que cumplan con las exigencias académicas científicas y que sean aprobados exitosamente. <br>
