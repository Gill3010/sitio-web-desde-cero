...
<head>
    ...
    <title>Sala o Galería Virtual Galería-Virtual</title>
...
<body>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
        ...
        <main>
            <img src="img/galeriavirtualdeafiches.jpg" class="banner"> 
            <div class=" bg-gris-2">
                <div class="container px-lg-5 bg-white">
                    <div class="pt-4 pb-5">
                        <div class="d-flex flex-column mb-3">
                            <h2>Sala de Galería Virtual de Afiches o Carteles para Eventos Particulares</h2>
                        </div>
                        <div>
                            <p class="text-justify">
                                Una galería virtual es la que se ha creado empleando un soporte gráfico e informático para mostrar las obras expuestas, resultados de investigaciones en un medio como internet.
                                <strong class="font-weight-bold">Un cartel virtual es una pantalla electrónica que se puede utilizar para transmitir información de la misma manera que lo hacían los carteles impresos tradicionales en el pasado, con una serie de funciones adicionales que lo convierten en una opción mucho mejor para la mayoría de las empresas.</strong>
                            </p>
                            <p class="text-justify">
                                Presenta información en pantalla, generalmente en formato gráfico. Combina texto, imágenes y elementos multimedia para transmitir un mensaje o compartir información de una manera visualmente atractiva. <br><br>
                                <strong class="font-weight-bold">Objetivos de una galería virtual:</strong> <br>
                                <div class="container">
                                    <p>
                                        <li>Ampliar la divulgación del conocimiento científico en comunidades académicas internacionales y
                                            sociedad.
                                        </li>
                                    </p>
                                    <p>
                                        <li>Fomentar el intercambio de resultados de investigación, proyectos de intervención y experiencias
                                            académicas entre estudiantes, profesores, investigadores y profesionales. </li>
                                    </p>
                                    <p>
                                        <li>Promover el desarrollo de competencias de investigación entre los diferentes actores de la
                                            divulgación
                                            científica. </li>
                                    </p>
                                    </div>
                                    <p>Pueden solicitar visibilidad de sus publicaciones, Afiche/ Cartel Científico/Poster Científico, los investigadores, profesionales, profesores y estudiantes de todos los niveles académicos inscritos en eventos como Congresos, Encuentros Científicos, Exposiciones, Conferencias, que han sido arbitrados por un comité evaluador (Comité académico, Revisores, Pares Académicos).
                                    </p>
                            </p>
