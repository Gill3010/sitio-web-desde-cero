...
<head>
    ...
    <title>Cursos de Capacitación Galería-Virtual</title>
...
<body>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
        ...
        <main>
            <img src="img/cursosdecapacitacion.jpg" class="banner"> 
            <div class=" bg-gris-2">
                    ...
                    <div class="pt-4 pb-5">
                        ...
                        <div>
                            <p class="text-justify">
                                Ofrecemos capacitaciones particularizadas y  consisten de actividades planeadas y basadas en las necesidades del interesado que se orientan hacia un cambio en los conocimientos,
                                <strong class="font-weight-bold"> habilidades y aptitudes  que les permitan desarrollar sus actividades de manera eficiente.</strong>
                            </p>
                            <p class="text-justify">
                                La capacitación juega un papel primordial para el logro de tareas y proyectos, dado que es el proceso mediante el cual los interesados adquieren los conocimientos, herramientas, habilidades y actitudes para interactuar en el entorno laboral o académico y cumplir con el trabajo que se les encomienda. <br><br>
                                <strong class="font-weight-bold">Características de nuestras capacitaciones de calidad:</strong> <br>
                                <div class="container">
                                    <p>
                                        <li>Programa concreto y manejo efectivo del tiempo.
                                        </li>
                                    </p>
                                    <p>
                                        <li>Identificación de las necesidades del grupo y de los objetivos de la empresa. </li>
                                    </p>
                                    <p>
                                        <li>Establecimiento de metas e instrumentos de medición. </li>
                                    </p>
                                    <p>
                                        <li>Fomento del liderazgo y del trabajo en equipo.</li>
                                    </p>
                                    <p>
                                        <li>Creatividad y dinamismo.</li>
                                    </p>
                                    <p>
                                        <li> Experiencias colaborativas.</li>
                                    </p>
