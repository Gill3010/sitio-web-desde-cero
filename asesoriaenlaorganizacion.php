...
<head>
    ...
    <title>Asesoría en la Organización de Eventos Científicos Galería-Virtual</title>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
       ...
       <nav class="navbar navbar-expand-lg shadow px-2 px-lg-3 py-2" id="menu" role="menubar">
        ...
        <main>
            <img src="img/organizaciondeeventos.jpg" class="banner"> 
            <div class=" bg-gris-2">
                <div class="container px-lg-5 bg-white">
                    <div class="pt-4 pb-5">
                        <div class="d-flex flex-column mb-3">
                            <h2>Asesoría en la Organización de Eventos Científicos</h2>
                        </div>
                        <div>
                            <p class="text-justify">
                                La etapa de <u><i>planificación</i></u> es esencial para los eventos científicos en general, ya se trate de un simposio, seminario, conferencia o congreso. Para que la organización de un evento sea eficaz, el equipo debe planificar un presupuesto que responda a las expectativas tanto de los organizadores como de los participantes.                                
                                <strong class="font-weight-bold">  Es necesario definir qué personas formarán parte del Comité Organizador, ya que son ellas las que guiarán los demás pasos y delegarán las demás tareas.</strong>
                                <p>Uno de los factores fundamentales para el buen desarrollo de cualquier evento científico es la divulgación. Hay que pensar en las estrategias que se utilizarán para que el evento llegue al mayor número de personas posible.</p>
                            </p>
                            <p class="text-justify">
                                Si todo lo anterior te resulta complicado o no tienes ni tiempo ni experiencia en esto, te podemos ayudar a lograr <strong class="font-weight-bold"> EVENTOS EXITOSOS</strong> que cumplan con las exigencias académicas científicas.
                                <br>
                            </p>
