...
<head>
    ...
    <title>Organización de Información Galería-Virtual</title>
...
<body>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
        ...
        <main>
            <img src="img/organizaciondeinformacion.jpg" class="banner"> 
            <div class=" bg-gris-2">
                    ...
                    <div class="pt-4 pb-5">
                        ...
                        <div>
                            <p class="text-justify">
                                Los reportes de investigación deben observar ciertas normas de formato y organización. Los detalles del formato (tipo y tamaño de fuente, márgenes, forma de citar las fuentes, presentación de la lista de referencias, entre otros), están regulados por cada institución. Por otro lado, otras características, como la organización general, reflejan las expectativas de la comunidad científica. De este modo, se espera que el informe contenga un resumen general,
                                 <strong class="font-weight-bold"> introducción (con los antecedentes y la motivación del estudio), materiales y métodos, resultados y el análisis de resultados.</strong>
                            </p>
                            <p class="text-justify">
                                Con mucho profesionalismo le podemos brindar distintas estrategias para apoyar su interés de desarrollar INFORMES de acuerdo a las exigencias de la instancia solicitante. <br>
                             </p>
