...
<head>
    ...
    <title>Normas APA para la Redacción Científica Galería-Virtual</title>
...
<body>
 ...
 <p>Ciencia, Innovación y Tecnología</p>
    ...
    <div class="d-flex px-3 py-2" id="encabezado" role="banner">
        ...
        <main>
            <img src="img/normaapaderedaccion.jpg" class="banner"> 
            <div class=" bg-gris-2">
                <div class="container px-lg-5 bg-white">
                    <div class="pt-4 pb-5">
                        <div class="d-flex flex-column mb-3">
                            <h2>Normas APA para la Redacción Científica
                            </h2>
                        </div>
                        <div>
                            <p class="text-justify">
                                Las Normas APA no sólo estructuran la presentación de los trabajos académicos y de investigación, sino que también elevan su calidad. Al exigir una uniformidad en la citación y referencia de fuentes, estas normas aseguran la claridad y coherencia en la comunicación de ideas. Este enfoque metódico facilita la comprensión del lector y fortalece la credibilidad del autor, al proporcionar un marco claro para el reconocimiento de las contribuciones intelectuales de terceros. promueve la integridad académica y fomenta una cultura de respeto y reconocimiento hacia el trabajo de otros investigadores. En resumen,                                 
                                <strong class="font-weight-bold">  las Normas APA son cruciales para la presentación rigurosa y ética de la investigación académica.</strong>
                                <p>El formato <strong>APA</strong> es un conjunto de normas de redacción que aborda el estilo de escritura, la organización, las citas y referencias y la preparación del manuscrito según lo determinado por la Asociación Americana de Psicología, o APA. Es el estilo más utilizado por estudiantes y profesionales de las disciplinas empresariales y universitarias.</p>
                            </p>
                            <p class="text-justify">
                                <strong class="font-weight-bold">¿Quieres conocer más sobre estas normas de redacción científicas u otras?</strong> <br> Te ayudamos a lograr presentaciones que cumplan con las exigencias académicas científicas y que sean aprobados exitosamente.
                                <br>
                           </p>
